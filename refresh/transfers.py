...
SQL_SELECT_EXPORT = '''
    ...
    WHERE   a.uhl_system_number IN (
            ...
            AND COALESCE(a.ward_start_date_time, datefromparts(2021, 06, 30)) <=  datefromparts(2021, 06, 30)
            AND COALESCE(a.ward_end_date_time, datefromparts(2021, 06, 30)) <=  datefromparts(2021, 06, 30)
    ;
'''
