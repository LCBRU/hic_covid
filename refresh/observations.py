...
SQL_SELECT_EXPORT = '''
    ...
    WHERE   a.uhl_system_number IN (
            ...
            AND COALESCE(a.observation_datetime, datefromparts(2021, 06, 30)) <=  datefromparts(2021, 06, 30)
            AND COALESCE(a.observation_start_datetime, datefromparts(2021, 06, 30)) <=  datefromparts(2021, 06, 30)
            AND COALESCE(a.observation_end_datetime, datefromparts(2021, 06, 30)) <=  datefromparts(2021, 06, 30)
    ;
'''
