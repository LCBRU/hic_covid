...
FROM hic_covid.transfer t
JOIN hic_covid.transfer t2
    ON t2.spell_id = t.spell_id
    AND (
        t2.transfer_datetime = (
            ...
            WHERE t3.spell_id = t.spell_id
                AND t3.transfer_datetime > t.transfer_datetime
        )
    )
JOIN hic_covid.demographics_filtered d
